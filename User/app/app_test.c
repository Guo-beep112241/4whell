...
#define APP_TEST_PID_TARGET_RPM 120.0f
#define APP_TEST_PID_RAMP_TIME_MS 2000u
#define APP_TEST_PID_HOLD_TIME_MS 3000u
...
#define APP_TEST_PID_KI 0.2f
#define APP_TEST_PID_KD 0.0f
#define APP_TEST_PID_INTEGRAL_LIMIT 100.0f
#define APP_TEST_PID_TUNE_FORWARD_PERCENT 40.0f
...
{
    float max_output = speed_max_percent;
    float integral_limit = speed_integral_limit;
...
{
    float target_rpm = APP_TEST_PID_TARGET_RPM;
    float fl_output;
    float fr_output;
    float rl_output;
    float rr_output;
...
void App_TestMotorPID70PercentForwardStart(void)
{
    ...
    App_TestClearOutputPercentDebug();
    App_TestSetAllTargetRPMDebug(APP_TEST_PID_TARGET_RPM);
